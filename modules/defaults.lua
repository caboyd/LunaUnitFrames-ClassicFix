...
function LUF:LoadDefaults()
	...
	self.defaults = {
		...
		profile = {
			...
			auratest = false,
			auratestBuffs = true,
			auratestDebuffs = true,
			auratestDispels = true,
			auratestUseFrameMax = false,
			auratestMaxBuffs = 32,
			auratestMaxDebuffs = 40,
			auratestRefreshAuras = true,
			tooltipCombat = true,
	...
	self.defaults.profile.units = {
		player = {
			...
			castBar = { enabled = true, background = true, backgroundAlpha = 0.2, height = 3, icon = "HIDE", shield = true, autoHide = true, order = 60, posSlot = "CENTER"},
		...
		raid = {
			...
			portrait = {enabled = false, type = "3D", alignment = "LEFT", width = 0.22, height = 4, order = 15, posSlot = "CENTER"},
			castBar = { enabled = false, background = true, backgroundAlpha = 0.2, height = 3, icon = "HIDE", shield = true, autoHide = true, order = 60, posSlot = "CENTER"},
			powerBar = { enabled = true, background = true, backgroundAlpha = 0.2, height = 1, order = 20, colorType = "type", vertical = true, posSlot = "RIGHT" },
			emptyBar = { enabled = false, height = 3, order = 50, reactionType="npc", class = true, alpha = 0.2, posSlot = "CENTER"},
			range = { enabled = false },
			highlight = { enabled = true, debuff = 2 },
			borders = { enabled = true, debuff = 2, size = 1 },
		...
		arena = {
			...
			trinket = {enabled = true, anchorPoint = "LEFT", size = 30, x = 0, y = 0 },
			slots = {
				left = {value = 10, orientation = "horizontal"},
				center = {value = 10, orientation = "vertical"},
				right = {value = 10, orientation = "horizontal"},
