...
if physicalClasses[select(2, UnitClass("player"))] then
    oUF.castImmunityBuffs[1022] = true -- Blessing of Protection (Rank 1)
    oUF.castImmunityBuffs[5599] = true -- Blessing of Protection (Rank 2)
    oUF.castImmunityBuffs[10278] = true -- Blessing of Protection (Rank 3)
    oUF.castImmunityBuffs[3169] = CLIENT_IS_CLASSIC_ERA or nil -- Limited Invulnerability Potion
else
    -- Cast immunity against magical classes only
    oUF.castImmunityBuffs[7121] = true -- Anti-Magic Shield (PvE 1)
    oUF.castImmunityBuffs[24021] = true -- Anti-Magic Shield (PvE 2)
    oUF.castImmunityBuffs[19645] = true -- Anti-Magic Shield (PvE 3)
    oUF.castImmunityBuffs[41451] = CLIENT_IS_TBC or nil -- Blessing of Spell Warding
end
