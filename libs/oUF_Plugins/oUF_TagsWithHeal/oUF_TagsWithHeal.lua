...
local _ENV = {
	...
	rangeCheck = function(unit) return LUF.GetUnitRangeBand(unit) end,
...
local tagEvents = {
	...
	["buffcount"]           = "UNIT_AURA UNIT_CONNECTION PARTY_MEMBER_ENABLE PARTY_MEMBER_DISABLE UNIT_IN_RANGE_UPDATE",
	...
	["status"]              = "UNIT_HEALTH UNIT_CONNECTION PARTY_MEMBER_ENABLE PARTY_MEMBER_DISABLE",
