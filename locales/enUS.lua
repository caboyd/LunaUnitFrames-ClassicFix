...
["How to apply the buff filter list"] = "Applied after the Filter Buffs dropdown. Whitelist shows only listed auras; blacklist hides them. Same-name ranks match.",
...
["How to apply the debuff filter list"] = "Applied after the Filter Debuffs dropdown. Whitelist shows only listed auras; blacklist hides them. Same-name ranks match.",
["Disabled"] = "Disabled",
["Whitelist"] = "Whitelist",
["Blacklist"] = "Blacklist",
["No Filter"] = "No Filter",
