...
["Partial (slow)"] = "Partial (slow)",
["Exact uses spell ID or full name (fast). Partial matches substrings (slow)."] = "Exact uses spell ID or full name (fast). Partial matches substrings (slow).",
["Name (exact) or ID of the effect to track. Use ; as a seperator for multiple auras"] = "Name (exact) or ID of the effect to track. Use ; as a seperator for multiple auras",
...
["casttimesmart"] = "Cast time of the unit's current cast, shows amount of time increased by knockback",
...
["Create and manage reusable aura filter lists"] = "Create and manage reusable aura filter lists",
["New Filter List"] = "New Filter List",
["Name for the new filter list"] = "Name for the new filter list",
["Create"] = "Create",
["Create a new filter list"] = "Create a new filter list",
["Delete this filter list"] = "Delete this filter list",
["Add Aura"] = "Add Aura",
["Search by aura name or enter an aura ID"] = "Search by aura name or enter an aura ID",
["Add this aura to the filter list"] = "Add this aura to the filter list",
["Auras in Filter"] = "Auras in Filter",
["Remove this aura from the filter list"] = "Remove this aura from the filter list",
["Buff Filter List"] = "Buff Filter List",
["Select a filter list to apply to buffs"] = "Select a filter list to apply to buffs",
["Buff Filter Mode"] = "Buff Filter Mode",
["How to apply the buff filter list"] = "Applied after the Filter Buffs dropdown. Whitelist shows only listed auras; blacklist hides them.",
["Debuff Filter List"] = "Debuff Filter List",
["Select a filter list to apply to debuffs"] = "Select a filter list to apply to debuffs",
["Debuff Filter Mode"] = "Debuff Filter Mode",
["How to apply the debuff filter list"] = "Applied after the Filter Debuffs dropdown. Whitelist shows only listed auras; blacklist hides them.",
["Buff Filter Match"] = "Buff Filter Match",
["Debuff Filter Match"] = "Debuff Filter Match",
["How to match the filter list"] = "Spell ID matches only that aura. Name matches every rank and any aura with the same name.",
["Spell ID"] = "Spell ID",
["Aura Name"] = "Aura Name",
["Disabled"] = "Disabled",
["Whitelist"] = "Whitelist",
...
["Select a filter list to edit"] = "Select a filter list to edit",
["Filters help tip"] = "Create filter lists below, then assign them to specific unit frames in each unit's Auras settings. Use Whitelist to show only listed auras, or Blacklist to hide them. Match by Spell ID for an exact aura, or by Name to include all ranks.",
["Aura search desc"] = "Enter a spell ID for an instant lookup, or a name to search. The first name search builds an index in the background; later searches are instant.",
...
["Building aura index"] = "Indexing auras (%d%%). Enter a spell ID to skip.",
}
