...
["Blizz Heal Prediction"] = "Blizzard Heilungsvorhersage",
["Use Blizzard heal prediction for direct heals"] = "Verwende Blizzards Heilungsvorhersage für direkte Heilungen",
...
["Name (partial) or ID of the effect to track. Use ; as a seperator for multiple auras"] = "Name (partiell) oder ID des anzuzeigenden Effektes. Benutze ; als Trennzeichen für mehrere Auren",
["Buff/Debuff"] = "St\195\164rkung/Schw\195\164chung",
["Own buff/debuff"] = "Eigene St\195\164rkung/Schw\195\164chung",
["Match"] = "Abgleich",
["Exact (fast)"] = "Exakt (schnell)",
["Partial (slow)"] = "Partiell (langsam)",
["Exact uses spell ID or full name (fast). Partial matches substrings (slow)."] = "Exakt verwendet die Zauber-ID oder den vollst\195\164ndigen Namen (schnell). Partiell gleicht Teilstrings ab (langsam).",
["Name (exact) or ID of the effect to track. Use ; as a seperator for multiple auras"] = "Name (exakt) oder ID des anzuzeigenden Effektes. Benutze ; als Trennzeichen f\195\188r mehrere Auren",
...
["Group by class or group"] = "Gruppe nach Klasse oder Gruppe",
["Tag Help"] = "Tag Hilfe",
...
["happiness"] = "Begleiter Zufriedenheit in 'ungl\195\188cklich','zufrieden' oder 'gl\195\188cklich'",
...
["maxpp"] = "Maximale Mana/Wut/Energie usw",
["smaxpp"] = "Maximale Mana/Wut/Energie usw gek\195\188rzt wenn \195\188ber 1K",
...
["casttimesmart"] = "Wirkungsdauer des aktuellen Zaubers, zeigt die durch Rückstoß reduzierte Zeit",
...
["percxppet"] = "Die aktuellen Erfahrungsprozente des Begleiters",
["rep"] = "Der Ruf des Spielers bei der aktuell beobachteten Fraktion",
["Info tags"] = "Info Tags",
...
["Border will always be on top of Frames"] = "Rahmen wird immer \195\188ber den Einheiten angezeigt",
["Shield icon"] = "Nicht unterbrechbarer Zauber",
["Shield icon desc"] = "Zeige einen Schild um das Zauberbild bei nicht unterbrechbaren Zaubern",
["Not interruptible cast"] = "Nicht unterbrechbarer Zauber",
["Color of cast bar when cast not interruptible"]  = "Farbe des Zauberbalkens bei nicht unterbrechbaren Zaubern",
["Not interruptible cast text"] = "Nicht unterbrechbarer Zaubertext",
["Color of cast bar text when cast not interruptible"] = "Farbe des Zauberbalken-Texts bei nicht unterbrechbaren Zaubern",
["BuffCountFontSize"] = "Schriftgrösse der Stärkungszauber-Anzahl",
["BuffCountFontSizeText"] = "Setze die Schriftgrösse der Anzahl für Stärkungszauber mit mehreren Stapeln",
["IndexOfDispel"] = "Index der Bannung",
["IndexOfDispelDesc"] = "Um die erste gefundene Bannung anzuzeigen, leer lassen oder 1 verwenden, für die zweite 2, 3 usw.",
["RaidManager"] = "Schlachtzugsmanager",
["Testing"] = "Testen",
["Test Auras"] = "Simuliere wechselnde Auren auf Einheitenfenstern für Leistungstests. Erfordert entsperrte Fenster.",
-- Filters
["Filters"] = "Filter",
["Spell Filters"] = "Zauberfilter",
["Create and manage reusable aura filter lists"] = "Wiederverwendbare Aura-Filterlisten erstellen und verwalten",
["New Filter List"] = "Neue Filterliste",
["Name for the new filter list"] = "Name f\195\188r die neue Filterliste",
["Create"] = "Erstellen",
["Create a new filter list"] = "Eine neue Filterliste erstellen",
["Delete this filter list"] = "Diese Filterliste l\195\182schen",
["Add Aura"] = "Aura hinzuf\195\188gen",
["Search by aura name or enter an aura ID"] = "Nach Aura-Name suchen oder Aura-ID eingeben",
["Add this aura to the filter list"] = "Diese Aura zur Filterliste hinzuf\195\188gen",
["Auras in Filter"] = "Auren im Filter",
["Remove this aura from the filter list"] = "Diese Aura aus der Filterliste entfernen",
["Buff Filter List"] = "Buff-Filterliste",
["Select a filter list to apply to buffs"] = "Eine Filterliste f\195\188r Buffs ausw\195\164hlen",
["Buff Filter Mode"] = "Buff-Filtermodus",
["How to apply the buff filter list"] = "Wie die Buff-Filterliste angewendet wird",
["Debuff Filter List"] = "Debuff-Filterliste",
["Select a filter list to apply to debuffs"] = "Eine Filterliste f\195\188r Debuffs ausw\195\164hlen",
["Debuff Filter Mode"] = "Debuff-Filtermodus",
["How to apply the debuff filter list"] = "Wie die Debuff-Filterliste angewendet wird",
["Buff Filter Match"] = "Buff-Filterabgleich",
["Debuff Filter Match"] = "Debuff-Filterabgleich",
["How to match the filter list"] = "Zauber-ID trifft nur diese Aura. Name trifft alle Ränge und alle Auren mit demselben Namen.",
["Spell ID"] = "Zauber-ID",
["Aura Name"] = "Auraname",
...
["Select a filter list to edit"] = "Eine Filterliste zum Bearbeiten ausw\195\164hlen",
["Filters help tip"] = "Erstelle unten Filterlisten und weise sie dann in den Aura-Einstellungen einzelner Einheitenfenster zu. Verwende den Positivlisten-Modus, um nur aufgef\195\188hrte Auren anzuzeigen, oder den Negativlisten-Modus, um sie auszublenden. Abgleich nach Zauber-ID f\195\188r eine genaue Aura, oder nach Name f\195\188r alle R\195\164nge.",
...
["Page %d/%d (%d results)"] = "Seite %d/%d (%d Ergebnisse)",
...
["Building aura index"] = "Auren werden indexiert (%d%%). Eine Zauber-ID \195\188berspringt dies.",
}
