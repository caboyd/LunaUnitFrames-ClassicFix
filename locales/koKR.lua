...
["Blizz Heal Prediction"] = "Blizz Heal Prediction",
["Use Blizzard heal prediction for direct heals"] = "Use Blizzard heal prediction for direct heals",
...
["casttimesmart"] = "유닛이 현재 시전하는 시전 시간 표시, shows amount of time reduced by knockback",
